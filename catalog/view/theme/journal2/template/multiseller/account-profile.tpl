...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
	...
	<form id="ms-sellerinfo" class="ms-form form-horizontal">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $ms_account_sellerinfo_bank; ?></label>
            <div class="col-sm-10">
                <input type="text" class="form-control"  name="seller[bank]" value="<?php echo $seller['ms.bank']; ?>" />
            <p class="ms-note"><?php echo $ms_account_sellerinfo_bank_note; ?></p>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $ms_account_sellerinfo_branch; ?></label>
            <div class="col-sm-10">
                <input type="text" class="form-control"  name="seller[branch]" value="<?php echo $seller['ms.branch']; ?>" />
            <p class="ms-note"><?php echo $ms_account_sellerinfo_branch_note; ?></p>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $ms_account_sellerinfo_accountname; ?></label>
            <div class="col-sm-10">
                <input type="text" class="form-control"  name="seller[accountname]" value="<?php echo $seller['ms.account_name']; ?>" />
            <p class="ms-note"><?php echo $ms_account_sellerinfo_account_name_note; ?></p>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $ms_account_sellerinfo_accountnumber; ?></label>
            <div class="col-sm-10">
                <input type="text" class="form-control"  name="seller[accountnumber]" value="<?php echo $seller['ms.account_number']; ?>" />
